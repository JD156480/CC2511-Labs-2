...
/*! \brief Send BEL character.
 *  \ingroup pico_term
 *
 * This function sends the ASCII bell character (BEL) to the terminal.
 * Terminal can be configured to respond to this character by flashing
 * the screen, beeping, etc.
 */
static inline void term_bell() {
  printf("\a");
}
